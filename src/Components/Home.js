                ...
                <div className='w-1/6 bg-flyPrimary100 h-auto '>
                    ...
                    <div className='text-center'>
                        <ItemSlider last={data?.vitals?.length} >
                            {
                                data && data?.vitals?.map((item, i) => (<div key={i} style={{ backgroundColor: vital == item ? "blue" : "" }} className={`flex justify-center text-[20px] cursor-pointer ${vital === item ? 'bg-blue-700' : ''}  `} onClick={() => setVital(item)}>{item} <br /><span className='text-sm bg-violet-600 text-white'> {timer}</span> </div>))
                            }
                        </ItemSlider>
                    </div>
                </div>
                <div className='w-1/6 bg-flyPrimary100 h-auto '>
                    ...
                    <div className='text-center'>
                        ...
                        <ItemSlider last={data?.billings?.length} >
                            {
                                data && data?.billings?.map((item, i) => (<div key={i} style={{ backgroundColor: billings == item ? "blue" : "" }} className={`flex justify-center text-[20px] cursor-pointer ${billings === item ? 'bg-blue-700' : ''}  `} onClick={() => setBillings(item)}>{item} <br /><span className='text-sm bg-violet-600 text-white'> {timer}</span> </div>))
                            }
                        </ItemSlider>
                    ...
                    <ul className=''>
                        <div className='text-center'>
                            ...
                            <ItemSlider last={data?.pharmacy?.length} >
                                {
                                    data && data?.pharmacy?.map((item, i) => (<div key={i} style={{ backgroundColor: pharmacy == item ? "blue" : "" }} className={`flex justify-center text-[20px] cursor-pointer ${pharmacy === item ? 'bg-blue-700' : ''}  `} onClick={() => setPharmacy(item)}>{item} <br /><span className='text-sm bg-violet-600 text-white'> {timer}</span> </div>))
                                }
                            </ItemSlider>
                ...
                <div className='w-1/6 bg-flyPrimary100 h-auto '>
                    ...
                    <div className='text-center'>
                        <ItemSlider last={data?.laboratory?.length} >
                            {
                                data && data?.laboratory?.map((item, i) => (<div key={i} style={{ backgroundColor: laboratory == item ? "blue" : "" }} className={`flex justify-center text-[20px] cursor-pointer ${laboratory === item ? 'bg-blue-700' : ''}  `} onClick={() => setLaboratory(item)}>{item} <br /><span className='text-sm bg-violet-600 text-white'> {timer}</span> </div>))
                            }
                        </ItemSlider>
                    </div>
                </div>
                <div className='w-1/6 bg-flyPrimary100 h-auto '>
                    ...
                    <div className='text-center'>
                        <ItemSlider last={data?.doctor?.length}>
                            {
                                data && data?.doctor?.map((item, i) => (<div key={i} style={{ backgroundColor: doctor == item ? "blue" : "" }} className={`flex justify-center text-[20px] cursor-pointer ${doctor === item ? 'bg-blue-700' : ''}  `} onClick={() => setDoctor(item)}>{item} <br /><span className='text-sm bg-violet-600 text-white'> {timer}</span> </div>))
                            }
                        </ItemSlider>
                    </div>
                </div>
